class AddStockForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    // onSubmit is passed down as a prop from Portfolio component, it refers to addStock
    this.props.onSubmit({
      name,
      shares_owned,
      cost_per_share,
  ...
  render() {
    ...
    return (
      <form className='col-12 mt-2 mb-4' onSubmit={this.addStock}>
        <input className='mx-2' name='name' type='text' placeholder='Name' onChange={this.handleChange} value={name} required />
        <input className='mx-2' name='shares_owned' type='number' placeholder='Shares' onChange={this.handleChange} value={shares_owned} />
        <input className='mx-2' name='cost_per_share' type='number' placeholder='Cost' onChange={this.handleChange} value={cost_per_share} />
        <input className='mx-2' name='market_price' type='number' placeholder='Price' onChange={this.handleChange} value={market_price} />
...
class Stock extends React.Component {
  render() {
    ...
    // Adopting the underscore style for consistency
