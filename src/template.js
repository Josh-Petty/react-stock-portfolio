      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <form className='col-12 mt-2 mb-4' onSubmit={this.addStock}>
            ...
            <input className='mx-2' name='shares_owned' type='number' placeholder='Shares' onChange={this.handleFormChange} value={form.shares_owned} />
            <input className='mx-2' name='cost_per_share' type='number' placeholder='Cost' onChange={this.handleFormChange} value={form.cost_per_share} />
            <input className='mx-2' name='market_price' type='number' placeholder='Price' onChange={this.handleFormChange} value={form.market_price} />
